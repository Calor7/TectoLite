...
[Download the latest portable Windows app](https://github.com/Calor7/TectoLite/releases/latest/download/TectoLite-Portable-1.0.8-x64.exe), or browse [all TectoLite releases](https://github.com/Calor7/TectoLite/releases).
